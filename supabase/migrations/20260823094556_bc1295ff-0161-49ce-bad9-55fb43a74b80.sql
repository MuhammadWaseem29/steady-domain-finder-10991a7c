...
select cron.schedule(
  ...
  select net.http_post(
    url:='https://project--52925200-8fb8-442c-88e1-e747035fac35.lovable.app/api/public/hooks/scan?limit=400&concurrency=48&budgetMs=33000&cycleMinutes=120&jobBudgetMs=8000',
