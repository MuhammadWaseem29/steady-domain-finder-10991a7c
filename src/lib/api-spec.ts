...
export const API_ENDPOINTS: ApiEndpoint[] = [
  ...
  {
    id: "platform-subdomains",
    group: "Platforms",
    method: "GET",
    path: "/platforms/{slug}/subdomains",
    summary: "All platform subdomains",
    description:
    ...
    params: [
      ...
      },
      {
        ...
        type: "string",
        required: false,
        description: "Cursor returned as meta.next_cursor by the previous page. Omit for the first page.",
      },
      limit(1000, 10000),
      {
        name: "program",
      ...
      },
      {
        ...
        required: false,
        default: "true",
        description: "Set false to include hosts that are no longer seen in Chaos.",
      },
      {
        name: "format",
        in: "query",
    ...
    responseExample: `{ "data": [ { "host": "api.tesla.com", "domain": "tesla.com", "is_active": true } ], "meta": { "count": 1000, "next_cursor": "ZDkx…", "has_more": true } }`,
  },
  {
    id: "platform-new",
    group: "Platforms",
